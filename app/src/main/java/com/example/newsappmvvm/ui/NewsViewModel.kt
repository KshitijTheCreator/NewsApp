...
import com.example.newsappmvvm.application.NewsApplication
...
) : AndroidViewModel(app) { // androidvm is same as view model but we can get the application context which will help us to check the internet is connected or not
